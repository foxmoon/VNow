...
//+ " jCallType text, g_code text,g_updatenum text,g_createtime text,g_head text,g_uuid text
...
//	jUserId text,f_uuid text, f_phone text, f_updatenum text, f_createtime text,"
