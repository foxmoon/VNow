...
/**
 * @author harry
 * @version Creat on 2014-6-27上午9:34:53
 */
public final class ActivityUtility
{
            ...
            View focusingView)
    {
        ...
        InputMethodManager imm = (InputMethodManager) activity
                .getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.showSoftInput(focusingView,
    ...
    {
        switchTo(activity, new Intent(activity,
                targetActivity));
    }
...
//                android.R.anim.fade_out);
            ...
            Class<? extends Activity> target, Params params)
    {
        ...
        if (null != params)
        {
            ...
            {
                IntentUtility.setValueToIntent(intent,
    ...
    public static void showAtCenter(
     ...
     *            消息内容
     */
    public static void showL(final Activity activity,
    ...
    public static int getStatusBarHeight(Activity activity)
    {
        try
        {
            ...
            int dpHeight = Integer.parseInt(field.get(
                    object).toString());
            return activity.getResources()
                    .getDimensionPixelSize(dpHeight);
        }
        catch (Exception e1)
        {
            e1.printStackTrace();
    ...
    public static int getScreenHeight(Activity paramActivity) {
        Display display = paramActivity.getWindowManager()
                .getDefaultDisplay();
    ...
    public static void openInput(final Context ctx, final EditText etx,
            boolean sheepTimeShort) {
